...
module.exports = React.createClass({
    ...
    getDefaultProps() {
        return {
            ...
            timer : 4000,
            api : 'http://ots.imike.com/ots/recommend/query?position=921A&cityid=30000&platform=2',
        }
    },
    ...
    fetchData() {
        var me = this;
          fetch(me.props.api, {
            ...
            .then((responseData) => {
                me.setState({
                    dataSource: responseData.banners
                });
          })
          .done(function(){
            me.start();
    ...
    start(){
        ...
        this.timer = this.setInterval(function(){
            ...
            scrollView.scrollResponderScrollTo(currentX,0,true);
    ...
    renderItems(data) {
        ...
        return data.map(function(item,i){
            ...
            return(
                <Image key={i} style={{width: width,height:itemHeight}} source={{uri: imgurl }}/>
            );
        })
    },
